<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<li class="nav-item {{ $slug == 'configure' ? 'active' : '' }}">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapesConfigure" aria-expanded="true" aria-controls="collapesConfigure">
		...
		<div id="collapesConfigure" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item {{ $title == 'province' ? 'active' : '' }}" href="{{ route('provinces.index') }}">Provinces</a>
