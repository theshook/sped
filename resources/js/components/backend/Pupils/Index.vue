<template>
  <div>
    <b-container class="full-height mt-2">
      <b-card class="shadow-sm">
        <b-card-body>
          <b-row>
            <b-col lg="6">
              <h2 class="text-primary font-weight-bold">Pupils</h2>
            </b-col>

            <b-col lg="6">
              <div class="d-flex justify-content-end align-baseline">
                <b-button variant="primary" size="sm" v-b-modal.add-modal @click="resetForm">
          ...
          <b-row class="mb-2">
            ...
            <b-col lg="6" class="d-flex justify-content-end align-content-end">
              <b-form class="col-sm-12 col-md-6 px-0">
                <b-form-input size="sm" v-model="search" @input="getPupils" placeholder="Search"></b-form-input>
              </b-form>
            </b-col>
          </b-row>
    ...
    >
      <b-form>
        <b-form-group label="Profile picture" label-class="text-sm" v-if="!image_url">
          <b-form-file
            ref="image_input"
          ...
          >This field is required and must be an image.</b-form-invalid-feedback>
        </b-form-group>
        ...
        <b-container class="text-center py-0 my-0" v-if="image_url" fluid>
          ...
          <b-container class="text-center mb-2" fluid>
            <b-button class="text-sm p-2 mx-2" variant="light" @click="changeImage">Change</b-button>

            <b-button class="text-sm p-2 mx-2" variant="light" @click="clearImage">Remove</b-button>
          </b-container>
        </b-container>
    ...
    <b-modal
      ...
      button-size="sm"
    >
      <p class="text-center text-muted mb-1">Are you sure you want to remove this pupil?</p>
    </b-modal>
  </div>
</template>
<script>
